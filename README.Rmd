...
[![Codecov test coverage](https://codecov.io/gh/aquaMetrics/halia/branch/main/graph/badge.svg)](https://app.codecov.io/gh/aquaMetrics/halia?branch=main)
<!-- badges: end -->

The goal of `halia` R package is to calculate the mixing zone area, fulfilling
